                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="correo" name="correo" 
                                       value="<?= htmlspecialchars($cliente['correo_cliente']) ?>" 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="telefono" name="telefono" 
                                       value="<?= htmlspecialchars($cliente['telefono_cliente']) ?>" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="direccion" name="direccion" 
                                       value="<?= htmlspecialchars($cliente['direccion_cliente']) ?>" 
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notas" name="notas" rows="4" 
                                      placeholder="Notas o observaciones sobre el cliente..."><?= 
                                htmlspecialchars($cliente['notas_cliente']) 
                            ?></textarea>
                            <div class="form-text text-muted mt-1">
                                <i class="fas fa-info-circle"></i>
                                Campo opcional para información adicional del cliente.
                            </div>
                        </div>
                    </div>
