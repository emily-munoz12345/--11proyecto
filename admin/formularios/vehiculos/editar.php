...
$title = 'Editar Vehículo | Nacional Tapizados';
?>
...
<body>
    <div class="main-container">
        <div class="header-section">
            <h1 class="page-title"><i class="fas fa-car"></i>Editar Vehículo</h1>
            ...
            <div class="card-body">
                <form action="procesar.php" method="POST">
                    ...
                    <div class="form-section">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="marca" name="marca" 
                                       value="<?= htmlspecialchars($vehiculo['marca_vehiculo']) ?>" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="modelo" name="modelo" 
                                       value="<?= htmlspecialchars($vehiculo['modelo_vehiculo']) ?>" 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="placa" class="form-label required-field">
                                    <i class="fas fa-id-card"></i>
                                    Placa
                                </label>
                                <input type="text" class="form-control" id="placa" name="placa" 
                                       value="<?= htmlspecialchars($vehiculo['placa_vehiculo']) ?>" 
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notas" name="notas" rows="4" 
                                      placeholder="Notas o observaciones sobre el vehículo..."><?= 
                                htmlspecialchars($vehiculo['notas_vehiculo']) 
                            ?></textarea>
                            <div class="form-text text-muted mt-1">
                                <i class="fas fa-info-circle"></i>
                                Campo opcional para información adicional del vehículo.
                            </div>
                        </div>
                    </div>
